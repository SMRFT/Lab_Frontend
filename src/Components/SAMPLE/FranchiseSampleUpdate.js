    ...
    const fetchSampleCollected = async () => {
      ...
      try {
        const response = await axios.get(
          `${Labbaseurl}get_franchise_Transferred/`
        );
  ...
  const updateTestStatus = async (patientId, testIndex) => {
    ...
    try {
      const response = await axios.put(
        `${Labbaseurl}update_franchise_sample/${patientId}/`,
        {
          updates: [
            {
              testIndex,
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Container>
        <Card>
          <Header>
            <Title>Franchise Sample Status</Title>
          </Header>
            ...
            <>
              {filteredPatients.length > 0 ? (
                ...
                <EmptyState>
                  ...
                  <EmptyStateText>
                    No samples found with the status "Sample Collected".
                  </EmptyStateText>
                </EmptyState>
              )}
            </>
...
export default FranchiseSampleUpdate;

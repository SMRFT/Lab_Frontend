...
const PatientOverallReport = ({ patient_id, date }) => {
  ...
  const handleSave = () => {
    ...
    axios.patch(`${Labbaseurl}credit_amount/${patient_id}/`, payload)
      .then(() => {
        ...
        <>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
            <div style={{ flex: 1 }}>
              ...
              <InputField type="text" value={patientData.patient_name} disabled />
            </div>
            <div style={{ flex: 1 }}>
              <label>Total Amount:</label>
              <InputField type="text" value={patientData.total_amount} disabled />
            </div>
          </div>
              ...
              <Table>
                ...
                <tbody>
                  {patientData.credit_details.map((detail, index) => (
                    <tr key={index}>
                      <Td>{new Date(detail.paid_date).toLocaleDateString()}</Td>

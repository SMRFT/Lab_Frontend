...
const Sidebar = () => {
 ...
 <SubLink to="/PatientForm" onClick={() => setIsSidebarOpen(false)}>
 Registration
 </SubLink>
...
{role === "Front Office" && (
 ...
 <SidebarNavLink to="/PaymentDashboard" onClick={() => setIsSidebarOpen(false)}>
 <IconWrapper>
 <DollarSign />
 </IconWrapper>
 Payment Dashboard
 </SidebarNavLink>
 <SidebarNavLink to="/RegisterDashboard" onClick={() => setIsSidebarOpen(false)}>
 <IconWrapper>
 <GrOverview />
 </IconWrapper>
 Billing Dashboard
 ...
 <DropdownHeader isOpen={dropdowns.salesDetails} onClick={() => toggleDropdown("salesDetails")}>
 <div style={{ display: "flex", alignItems: "center" }}>
 <IconWrapper>
 <TbReport />
 </IconWrapper>
 ...
 <SubLink to="/SalesVisitLog" onClick={() => setIsSidebarOpen(false)}>
 Sales Visit Form
 </SubLink>
 <SubLink to="/SalesReport" onClick={() => setIsSidebarOpen(false)}>
 Sales Report
 </SubLink>
 </DropdownContent>
 <SidebarNavLink to="/B2B" onClick={() => setIsSidebarOpen(false)}>
 ...
 <SubLink to="/CashTally" onClick={() => setIsSidebarOpen(false)}>
 Cash Tally
 </SubLink>
 <SubLink to="/Refund" onClick={() => setIsSidebarOpen(false)}>
 Refund
 </SubLink>
 <SubLink to="/Cancellation" onClick={() => setIsSidebarOpen(false)}>
 Cancellation
 </SubLink>
 ...
 <DropdownContent isOpen={dropdowns.salesDetails}>
 <SubLink to="/SalesVisitLogReport" onClick={() => setIsSidebarOpen(false)}>
 Sales Visit Report
 </SubLink>
 ...
 <SidebarNavLink to="/B2BFinalApproval" onClick={() => setIsSidebarOpen(false)}>
 <IconWrapper>
 <GrOverview />
 </IconWrapper>
  B2B Approval
...
{role === "General Manager" && (
 ...
 <GrOverview />
  ...
  B2B 
   ...
   <SidebarNavLink to="/B2BReport" onClick={() => setIsSidebarOpen(false)}>
 <IconWrapper>
 <GrOverview />
 </IconWrapper>
  B2B Report
 </SidebarNavLink>
 <SidebarNavLink to="/B2BApproval" onClick={() => setIsSidebarOpen(false)}>
 <IconWrapper>
 <GrOverview />
 </IconWrapper>
  B2B Approval
             ...
             <DropdownContent isOpen={dropdowns.patientDetails}>
               ...
               <SubLink to="/PatientEditForm" onClick={() => setIsSidebarOpen(false)}>
                 Patient Edit
               </SubLink>
             </DropdownContent>
 ...
 Cancellation
             ...
             <SidebarNavLink to="/Registration" onClick={() => setIsSidebarOpen(false)}>
               <IconWrapper>
                 <FaUserPlus />
               </IconWrapper>
               User Rights

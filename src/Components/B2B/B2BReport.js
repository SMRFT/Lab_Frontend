...
const Badge = styled.span`
  ...
  background-color: ${(props) => (props.status === "APPROVED" ? "rgba(40, 167, 69, 0.1)" : "rgba(108, 117, 125, 0.1)")};
  color: ${(props) => (props.status === "APPROVED" ? "#28a745" : "var(--gray)")};
`
...
const B2BReport = () => {
  ...
  const filteredData = useMemo(() => {
    return data.filter((item) => {
      const matchesSearch =
        !searchTerm ||
        (item.clinicalname && item.clinicalname.toLowerCase().includes(searchTerm.toLowerCase())) ||
        (item.referrerCode && item.referrerCode.toLowerCase().includes(searchTerm.toLowerCase()))
        ...
        <Card>
          ...
          <CardBody>
            ...
            <FilterContainer>
              ...
              <Select value={b2bTypeFilter} onChange={(e) => setB2bTypeFilter(e.target.value)}>
                      ...
                      <>
                        <Tr key={index}>
                          ...
                          <Td style={{ textAlign: "center" }}>
                            <Button primary onClick={() => handleViewDetails(item, index)}>
                              <Eye size={14} />
                              View
                            </Button>
                          </Td>
                        ...
                        {selectedItem && selectedIndex === index && (
                          <Tr key={`details-${index}`}>
                            <Td colSpan="7" style={{ padding: 0, border: "none" }}>
                              <DetailCard
                                style={{ margin: 0, boxShadow: "none", border: "2px solid var(--primary-light)" }}
                              >
                                ...
                                <DetailBody expanded={expandedDetails}>
                                  ...
                                  <DetailGrid>
                                    <DetailSection>
                                      <SectionTitle>
                                        <CreditCard size={16} /> Credit Information
                                      </SectionTitle>
                                      <InfoItem>
                                    ...
                                    <DetailSection>
                                      <SectionTitle>
                                        <FileText size={16} /> Report Preferences
                                      </SectionTitle>
                                      <InfoItem>
            ...
            {filteredData.length > 0 && (
              <PaginationContainer>
                <PaginationInfo>
                  ...
                  {(searchTerm || statusFilter || b2bTypeFilter) && ` (filtered from ${data.length} total entries)`}
                </PaginationInfo>
          ...
          <ModalContent onClick={(e) => e.stopPropagation()}>
            ...
            <ModalBody>
              {previewModal.loading && (
                <PreviewLoading>
                  <LoadingSpinner />
                  <p style={{ marginTop: "1rem" }}>Loading document preview...</p>
                </PreviewLoading>
              )}
 <iframe 
